...
class PurePursuit(object):
    ...
    def __init__(self):
        ...
        wp_viz_topic = '/wp_viz'
        self.nearest_wp_pub = rospy.Publisher(wp_viz_topic, Marker, queue_size = 10)
    ...
    def odom_callback(self, odom_msg):
        ...
        self.create_waypoint_marker(lookahead_waypoint_idx)
        ...
        ang_goal_x = self.plan[lookahead_waypoint_idx][0] # need to implement lookahead
        ang_goal_y = self.plan[lookahead_waypoint_idx][1] # need to implement lookahead
    ...
    def create_waypoint_marker(self, waypoint_idx):
