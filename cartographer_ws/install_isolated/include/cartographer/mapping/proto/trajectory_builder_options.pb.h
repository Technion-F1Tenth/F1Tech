...
class TrajectoryBuilderOptions_PureLocalizationTrimmerOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptions.PureLocalizationTrimmerOptions) */ {
 public:
  ...
  inline TrajectoryBuilderOptions_PureLocalizationTrimmerOptions* New() const { return New(NULL); }

  TrajectoryBuilderOptions_PureLocalizationTrimmerOptions* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static TrajectoryBuilderOptions_PureLocalizationTrimmerOptions* default_instance_;
};
// -------------------------------------------------------------------
