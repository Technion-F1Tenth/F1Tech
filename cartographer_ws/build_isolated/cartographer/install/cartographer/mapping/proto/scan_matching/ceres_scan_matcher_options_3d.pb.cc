...
const ::google::protobuf::Descriptor* IntensityCostFunctionOptions_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  IntensityCostFunctionOptions_reflection_ = NULL;
...
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto() {
  ...
  IntensityCostFunctionOptions_descriptor_ = file->message_type(0);
  static const int IntensityCostFunctionOptions_offsets_[3] = {
  ...
  IntensityCostFunctionOptions_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      IntensityCostFunctionOptions_descriptor_,
      IntensityCostFunctionOptions::default_instance_,
      IntensityCostFunctionOptions_offsets_,
      -1,
      -1,
      -1,
      sizeof(IntensityCostFunctionOptions),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(IntensityCostFunctionOptions, _internal_metadata_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(IntensityCostFunctionOptions, _is_default_instance_));
  CeresScanMatcherOptions3D_descriptor_ = file->message_type(1);
  static const int CeresScanMatcherOptions3D_offsets_[6] = {
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      IntensityCostFunctionOptions_descriptor_, &IntensityCostFunctionOptions::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto() {
  delete IntensityCostFunctionOptions::default_instance_;
  delete IntensityCostFunctionOptions_reflection_;
...
void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto() {
  ...
  IntensityCostFunctionOptions::default_instance_ = new IntensityCostFunctionOptions();
  CeresScanMatcherOptions3D::default_instance_ = new CeresScanMatcherOptions3D();
  IntensityCostFunctionOptions::default_instance_->InitAsDefaultInstance();
...
const ::google::protobuf::Descriptor* IntensityCostFunctionOptions::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return IntensityCostFunctionOptions_descriptor_;
}
...
IntensityCostFunctionOptions* IntensityCostFunctionOptions::default_instance_ = NULL;
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(IntensityCostFunctionOptions, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  &reinterpret_cast<IntensityCostFunctionOptions*>(16)->f)
#endif
...
#define ZR_(first, last) do {\
  ...
  ZR_(weight_, intensity_threshold_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(17)) goto parse_huber_scale;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_intensity_threshold;
        break;
      }
...
int IntensityCostFunctionOptions::ByteSize() const {
...
::google::protobuf::Metadata IntensityCostFunctionOptions::GetMetadata() const {
  ...
  metadata.descriptor = IntensityCostFunctionOptions_descriptor_;
  metadata.reflection = IntensityCostFunctionOptions_reflection_;
  return metadata;
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_intensity_cost_function_options;
        break;
      }
      ...
      case 7: {
        if (tag == 58) {
         parse_intensity_cost_function_options:
          DO_(input->IncrementRecursionDepth());
         parse_loop_intensity_cost_function_options:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
                input, add_intensity_cost_function_options()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(58)) goto parse_loop_intensity_cost_function_options;
...
void CeresScanMatcherOptions3D::SerializeWithCachedSizes(
  ...
  // repeated .cartographer.mapping.scan_matching.proto.IntensityCostFunctionOptions intensity_cost_function_options = 7;
  for (unsigned int i = 0, n = this->intensity_cost_function_options_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->intensity_cost_function_options(i), output);
  }
...
::google::protobuf::uint8* CeresScanMatcherOptions3D::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->intensity_cost_function_options_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        7, this->intensity_cost_function_options(i), false, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.scan_matching.proto.CeresScanMatcherOptions3D)
  ...
  // repeated .cartographer.mapping.scan_matching.proto.IntensityCostFunctionOptions intensity_cost_function_options = 7;
  total_size += 1 * this->intensity_cost_function_options_size();
  for (int i = 0; i < this->intensity_cost_function_options_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->intensity_cost_function_options(i));
  }
...
void CeresScanMatcherOptions3D::InternalSwap(CeresScanMatcherOptions3D* other) {
  ...
  intensity_cost_function_options_.UnsafeArenaSwap(&other->intensity_cost_function_options_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
