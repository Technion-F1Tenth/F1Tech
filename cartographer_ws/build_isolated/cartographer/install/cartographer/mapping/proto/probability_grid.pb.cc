...
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() {
  protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto);
}
...
void protobuf_ShutdownFile_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() {
  delete ProbabilityGrid::default_instance_;
  delete ProbabilityGrid_reflection_;
}

void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\021\n\017ProbabilityGridb\006proto3", 106);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto {
  StaticDescriptorInitializer_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto() {
    protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto();
  }
} static_descriptor_initializer_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto_;
...
const ProbabilityGrid& ProbabilityGrid::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto();
