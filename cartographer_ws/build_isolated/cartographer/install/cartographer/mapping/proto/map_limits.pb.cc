...
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() {
  protobuf_AddDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto);
}
...
void protobuf_ShutdownFile_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() {
  delete MapLimits::default_instance_;
  delete MapLimits_reflection_;
}

void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::cartographer::mapping::proto::protobuf_AddDesc_cartographer_2fmapping_2fproto_2fcell_5flimits_5f2d_2eproto();
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto {
  StaticDescriptorInitializer_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto() {
    protobuf_AddDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto();
  }
} static_descriptor_initializer_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto_;
...
const MapLimits& MapLimits::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto();
