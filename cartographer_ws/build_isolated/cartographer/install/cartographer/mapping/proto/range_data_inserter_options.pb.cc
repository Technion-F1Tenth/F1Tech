...
void protobuf_AddDesc_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto() {
  ...
  ::cartographer::mapping::proto::protobuf_AddDesc_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto();
  ::cartographer::mapping::proto::protobuf_AddDesc_cartographer_2fmapping_2fproto_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto();
...
void RangeDataInserterOptions::InitAsDefaultInstance() {
  ...
  tsdf_range_data_inserter_options_2d_ = const_cast< ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D*>(&::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D::default_instance());
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_tsdf_range_data_inserter_options_2d;
        break;
      }

      // optional .cartographer.mapping.proto.TSDFRangeDataInserterOptions2D tsdf_range_data_inserter_options_2d = 3;
      case 3: {
        if (tag == 26) {
         parse_tsdf_range_data_inserter_options_2d:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
...
::google::protobuf::uint8* RangeDataInserterOptions::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_tsdf_range_data_inserter_options_2d()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, *this->tsdf_range_data_inserter_options_2d_, false, target);
  }
...
void RangeDataInserterOptions::InternalSwap(RangeDataInserterOptions* other) {
  ...
  std::swap(tsdf_range_data_inserter_options_2d_, other->tsdf_range_data_inserter_options_2d_);
...
bool RangeDataInserterOptions::has_tsdf_range_data_inserter_options_2d() const {
  return !_is_default_instance_ && tsdf_range_data_inserter_options_2d_ != NULL;
}
...
const ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D& RangeDataInserterOptions::tsdf_range_data_inserter_options_2d() const {
  ...
  return tsdf_range_data_inserter_options_2d_ != NULL ? *tsdf_range_data_inserter_options_2d_ : *default_instance_->tsdf_range_data_inserter_options_2d_;
}
